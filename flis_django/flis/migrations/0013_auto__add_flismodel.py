...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flis_flismodel', (
            ...
            ('steep_category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='models', null=True, on_delete=models.PROTECT, to=orm['flis.SteepCategory'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='models', on_delete=models.PROTECT, to=orm['flis.Source'])),
    ...
    models = {
        ...
        'flis.flismodel': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'models'", 'on_delete': 'models.PROTECT', 'to': "orm['flis.Source']"}),
            'steep_category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'models'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['flis.SteepCategory']"}),
