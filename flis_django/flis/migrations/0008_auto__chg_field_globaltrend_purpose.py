...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GlobalTrend.purpose'
        db.alter_column('flis_globaltrend', 'purpose', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'GlobalTrend.purpose'
        db.alter_column('flis_globaltrend', 'purpose', self.gf('django.db.models.fields.CharField')(max_length=1024))
    ...
    models = {
        ...
        'flis.globaltrend': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'purpose': ('django.db.models.fields.TextField', [], {'default': "''"}),
