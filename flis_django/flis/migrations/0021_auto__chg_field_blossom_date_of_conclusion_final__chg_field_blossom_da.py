...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('flis_blossom', 'date_of_conclusion_final', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Blossom.date_of_conclusion_planned'
        db.add_column('flis_blossom', 'date_of_conclusion_planned', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Blossom.date_of_conclusion_planned'
        db.add_column('flis_blossom', 'date_of_conclusion_planned', self.gf('django.db.models.fields.DateTimeField')(null=True))
