...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GMT.file_id'
        db.add_column('flis_gmt', 'file_id',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trend.file_id'
        db.add_column('flis_trend', 'file_id',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GMT.file_id'
        db.delete_column('flis_gmt', 'file_id')

        # Deleting field 'Trend.file_id'
        db.delete_column('flis_trend', 'file_id')
