...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Country.iso'
        db.alter_column('flis_country', 'iso', self.gf('django.db.models.fields.CharField')(max_length=128, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Country.iso'
        db.alter_column('flis_country', 'iso', self.gf('django.db.models.fields.CharField')(max_length=3, primary_key=True))
