...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Indicator.geographic_coverage'
        db.rename_column('flis_indicator', 'geographic_coverage_id', 'geographical_coverage_id')

    def backwards(self, orm):
        db.rename_column('flis_indicator', 'geographical_coverage_id', 'geographic_coverage_id')
