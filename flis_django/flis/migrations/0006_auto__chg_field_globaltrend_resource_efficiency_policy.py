...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GlobalTrend.resource_efficiency_policy'
        db.alter_column('flis_globaltrend', 'resource_efficiency_policy', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'GlobalTrend.resource_efficiency_policy'
        db.alter_column('flis_globaltrend', 'resource_efficiency_policy', self.gf('django.db.models.fields.CharField')(max_length=2048))
