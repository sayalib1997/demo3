...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GlobalTrend'
        db.create_table('flis_globaltrend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('resource_efficiency_policy', self.gf('django.db.models.fields.CharField')(default='', max_length=2048)),
            ('time_frame', self.gf('django.db.models.fields.IntegerField')(default='2013')),
            ('purpose', self.gf('django.db.models.fields.CharField')(default='', max_length=1024)),
            ('geographical_scope', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('whats_out', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
        ))
        db.send_create_signal('flis', ['GlobalTrend'])


    def backwards(self, orm):
        # Deleting model 'GlobalTrend'
        db.delete_table('flis_globaltrend')
    ...
    models = {
        ...
        'flis.globaltrend': {
            ...
            'resource_efficiency_policy': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2048'}),
            'time_frame': ('django.db.models.fields.IntegerField', [], {'default': "'2013'"}),
