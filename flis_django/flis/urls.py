...
urlpatterns = patterns('',
    ...
    url(r'^global_trends$', views.GlobalTrends.as_view(), name='global_trends'),
    url(r'^global_trends/new$', views.GlobalTrendCreate.as_view(), name='global_trend_new'),
    url(r'^global_trends/(?P<pk>\d+)/edit$',
        auth.edit_is_allowed(views.GlobalTrendEdit.as_view()),
        name='global_trend_edit'),
    url(r'^global_trends/(?P<pk>\d+)/$', views.GlobalTrend.as_view(), name='global_trend_view'),
    url(r'^global_trends/(?P<pk>\d+)/delete$',
        auth.edit_is_allowed(views.GlobalTrendDelete.as_view()),
        name='global_trend_delete'),
