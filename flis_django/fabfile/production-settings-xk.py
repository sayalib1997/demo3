...
HOSTNAME = "http://projects.eionet.europa.eu/flis-services-project/xk"
FORCE_SCRIPT_NAME = '/flis-services-project/xk/'
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'flis_xk',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = path('/var/local/naaya/flis_countries/xk/instance')
