...
HOSTNAME = "http://projects.eionet.europa.eu/flis-services-project/article-5-contribution"
FORCE_SCRIPT_NAME = '/flis-services-project/article-5-contribution/'
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'article5',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = path('/var/local/naaya/flis_django/article5/instance')
